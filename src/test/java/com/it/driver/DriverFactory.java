...
public class DriverFactory {
    public static WebDriver getDriver() {
        ...
        if ("firefox".equals(driverSysProperty)) {
            System.setProperty("webdriver.gecko.driver", "/Users/MB/Downloads/myNewProjectEx-master/drivers/geckodriver");
            driver = new FirefoxDriver();
        } else {
            System.setProperty("webdriver.chrome.driver", "/Users/MB/Downloads/myNewProjectEx-master/drivers/chromedriver");
